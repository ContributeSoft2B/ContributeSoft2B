...
namespace Contribute.Controllers
{
    public class TelegramController : Controller
    {
        ...
        public ActionResult Verification(string verificationCode)
        {
            ...
            db.SaveChanges();
            return Json(new { success = true, msg = $"收到验证码:{verificationCode},恭喜你验证成功，赶快把邀请链接分享给好友，每成功推荐一个好友入群，即可获得40个OB! \n Receive verification code:{verificationCode},Verify success, quickly share the invite link to friends, each successful recommendation during the event a group of friends, you can get 40 OB!", data.InviteUrl }, JsonRequestBehavior.AllowGet);
        }
        /// <summary>
